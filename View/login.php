...
<head>
    ...
    <title>R&A Nacionais e Importados</title>
...
<body>
    <div class="container-fluid" id="container_login">
        <div class="row">
            <div class="col-6">
                <svg style="margin-left: 10%; margin-top: 10%; width: 500px; height: 500px;" id="a684e1c6-71e2-413d-b570-2a7a579de6f7" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="1029.56255" height="548.69495" viewBox="0 0 1029.56255 548.69495">
                    ...
                    <rect x="242.98506" y="250.93227" width="52" height="8.05267" fill="#dc3545" />
                    ...
                    <path d="M712.99462,449.86668h-.94478V444.063h.94478Zm0-11.6073h-.94478V432.4555h.94478Zm0-11.60753h-.94478V420.8482h.94478Zm0-11.6073h-.94478V409.2409h.94478Zm0-11.6073h-.94478v-5.80388h.94478Zm0-11.60753h-.94478v-5.80365h.94478Zm0-11.60731h-.94478v-5.80365h.94478Zm0-11.6073h-.94478v-5.80365h.94478Zm0-11.60753h-.94478v-5.80365h.94478Zm0-11.6073h-.94478v-5.80365h.94478Z" transform="translate(-85.21873 -175.65252)" fill="#e5e5e5" />
                    ...
                    <path d="M609.3187,450.17576h-.94478V444.6812h.94478Zm0-10.98936h-.94478v-5.49456h.94478Zm0-10.98936h-.94478v-5.49456h.94478Zm0-10.98936h-.94478v-5.49456h.94478Zm0-10.98936h-.94478v-5.49456h.94478Zm0-10.98936h-.94478v-5.49457h.94478Zm0-10.98936h-.94478V378.745h.94478Zm0-10.98936h-.94478v-5.49457h.94478Zm0-10.98936h-.94478v-5.49457h.94478Z" transform="translate(-85.21873 -175.65252)" fill="#e5e5e5" />
                    ...
                    <circle cx="471.66442" cy="210.75355" r="5.87317" fill="#dc3545" />
                    <circle cx="523.54411" cy="172.57792" r="5.87317" fill="#dc3545" />
                    <circle cx="575.42381" cy="210.75355" r="5.87317" fill="#dc3545" />
                    <circle cx="627.3035" cy="153.97954" r="5.87317" fill="#dc3545" />
                    <circle cx="679.1832" cy="132.44458" r="5.87317" fill="#dc3545" />
                    ...
                    <path d="M961.48266,420.76584l-30.07691.75236-17.65821,9.065-.96906,66.87968-11.0131,46.17488s68.811,4.73581,78.32355-2.1824L968.84683,488.704,983.925,431.69483Z" transform="translate(-85.21873 -175.65252)" fill="#dc3545" />
                    <path d="M916.96023,431.62873l-3.21269-1.04552s-10.19135,6.54059-9.22166,22.35367c0,0-.382,8.1827-.01724,13.62852.41834,6.24634-12.10688,68.31736-12.10688,68.31736h18.16032l7.783-56.21048Z" transform="translate(-85.21873 -175.65252)" fill="#dc3545" />
                    ...
                    <path d="M979.39949,432.4935l3.2127-1.04551s10.19134,6.54059,9.22166,22.35367c0,0,.382,8.1827.01724,13.62852-.41834,6.24634,5.18866,68.31736,5.18866,68.31736H978.87944l-7.783-56.21049Z" transform="translate(-85.21873 -175.65252)" fill="#dc3545" />
                    ...
                    <path d="M927.23562,364.702c2.44244-5.25207,7.169-4.21369,11.30278-2.43339,5.23475-1.16114,10.21334-4.63745,15.85348-2.58158,5.55578,8.08056,24.209,5.70314,20.24058,18.85835-.00519,3.15227,5.93159,1.31744,4.89514,6.48014,3.14494,9.93555-11.35179,28.752-19.674,24.78956,2.05822-3.77215,6.76-12.34-.37128-13.18978-15.34037,14.27367-1.58274-27.18028-20.85755-15.1248C932.24272,387.341,923.50556,370.544,927.23562,364.702Z" transform="translate(-85.21873 -175.65252)" fill="#2f2e41" />
                </svg>
            </div>
            <div class="col-6">
                <div class="card shadow-lg p-3 mb-5 bg-white rounded" style="margin-right: 10%; margin-top: 5%;">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                                <center>
                                    <img style="width: 180px;" src="img/RA.png">
                                </center>
                            </div>
                            <div class="col-6">
                                <h1 style="text-align: center; margin-top: 20px;">Lojas R&A Nacionais e Importados </h1>
                            </div>
                        </div>
                        ...
                        <form method="POST" action="../Controller/valida_login.php">
                            ...
                            <button class="btn btn-lg btn-danger" id="botao" type="submit">
                                <h4>Acessar</h4>
                            </button>
                        </form>
                        ...
                        <p class=" text-muted" style="text-align: center;"> R&A Nacionais e Importados © 2011-2021</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- <center>
        ...
        <p class=" text-muted" style="text-align: center;"> R&A Nacionais e Importados © 2019-2021</p> -->
    </div>
